...
describe('Component GalleryComponent', () => {
  ...
  it('should render a spinner the time to get the answer from the back end.', async () => {
    ...
    // Act
    const galleryComponent = mount(<GalleryComponent parentUiId={parentUiId} isLoading images={images} onClickThumbnail={onClickThumbnail} addImage={addImage} turnOnCamera={turnOnCamera} />);
