...
const PrivacyPolicyModalBodyEn = ({ deleteAllUserData }: Props) => (
  <ModalBody>
    ...
    <ArticleCollapsable className="level-1" title="CCPA Privacy Rights (Do Not Sell My Personal Information)">
      ...
      <p>Request that a business delete any personal data about the consumer that a business has collected by clicking the button below</p>
      <Button color="danger" onClick={deleteAllUserData}>Delete all the user's data...</Button>
    ...
    <ArticleCollapsable className="level-1" title="GDPR Data Protection Rights">
      ...
      <p>The right to erasure – You have the right to request that we erase your personal data by clicking the below button</p>
      <Button color="danger" onClick={deleteAllUserData}>Delete all the user's data...</Button>
