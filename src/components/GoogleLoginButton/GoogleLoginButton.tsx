...
import jsonMessages from './GoogleLoginButton.messages.json';
...
const GoogleLoginButton = ({ intl, className }: {intl: IntlShape, className: string | undefined}) => {
  ...
  return (
    <a href={`${process.env.REACT_APP_API_URL_BASE}users/login/google`} className={classnames(className, 'button')}>
